...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">تعديل خطة الاشتراك: {{ $subscriptionPlan->name }}</h1>
        </div>
            ...
            <form action="{{ route('admin.subscription-plans.update', $subscriptionPlan) }}" method="POST">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="lemon_squeezy_variant_id" value="{{ old('lemon_squeezy_variant_id', $subscriptionPlan->lemon_squeezy_variant_id) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                               required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_monthly" value="{{ old('price_monthly', $subscriptionPlan->price_monthly) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                               required>
                        @error('price_monthly')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="number" name="monthly_quiz_limit" value="{{ old('monthly_quiz_limit', $subscriptionPlan->monthly_quiz_limit) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                               required>
                    ...
                    <div>
                        ...
                        <input type="number" name="monthly_ai_text_limit" value="{{ old('monthly_ai_text_limit', $subscriptionPlan->monthly_ai_text_limit) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                               required>
                    ...
                    <div>
                        ...
                        <input type="number" name="monthly_ai_quiz_limit" value="{{ old('monthly_ai_quiz_limit', $subscriptionPlan->monthly_ai_quiz_limit) }}" 
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                               required>
