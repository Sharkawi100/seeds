...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\roots\public\storage' => 'string',
            ...
            'services.claude.key' => 'string',
            'services.claude.model' => 'string',
            'services.claude.max_tokens' => 'string',
            'services.claude.temperature' => 'string',
            'services.claude.cache_enabled' => 'boolean',
            'services.claude.timeout' => 'string',
...
'filesystems.links.C:\\xampp\\htdocs\\roots\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.claude.key','services.claude.model','services.claude.max_tokens',
'services.claude.temperature','services.claude.cache_enabled','services.claude.timeout','services.google.client_id','services.google.client_secret',
...
'sanctum.csrf-cookie','generated::sm7qJbbrA4bduDGH','generated::qkZh9S35olCpVIxm','generated::M6fyOjLBz9457OcB','generated::T9ulOTPE584cMVTH',
'generated::M8JHnm9Spw7Ij75P','generated::1e7plWM1LC3k54IT','generated::X0YhTDmi3aeEbwgb','generated::Tx8lsyoY1WP3rau0','generated::H6NX9ACWShMj9z9d',
'generated::RishRdKwJQn27bY3','generated::622Us23nJOaZsrry','generated::Abq4e5wRjei2Pu1b','generated::MxxiQxiIf7DUHQAl','generated::V1ZAIa7oesEvM9P7',
'generated::PVGm7ZzyoAFh9WLX','generated::F3D4ggX8mtufLaFs','generated::gVXJevhb7FGv9BmE','generated::EBD6qOiqOXLkIN23','generated::iXHTedb2VM4LOn5q',
'generated::5IFYf5RQIyq9pvZZ','generated::MksFZbbgs7Aski7Y','generated::1IuSqiI6x1fCMWGG','generated::4tCgPIw2IvLj0SFc','generated::bTPdiftJLxryDEJL',
'generated::uQuDBkR5EPsc3Y3J','generated::7zKSifDA0ulrPVXP','generated::2i7UliWWhIOsZVfw','generated::oy8uqlc9w6bEEiQh','generated::N48i92g62EVvYctt',
'generated::PBGRMfkKgswMupZt','generated::4swii0kvCDNMFbVP','generated::wxTZnGVE2DPNxORW','generated::lLES4TRxaXzkya6n','generated::1nbvT1bvzYyanjCD',
'generated::1nXCQR0DBxOzcR2N','generated::vWelH4m6yEGVAGFJ','generated::Qq6J8OKkCvBIitmR','generated::mYUeSB8BEKBqVKIX','home',
'about','juzoor.model','question.guide','contact','contact.submit',
'lang.switch','quiz.enter-pin','quiz.demo','quiz.take','quiz.submit',
'results.show','dashboard','profile.edit','profile.update','profile.destroy',
'quizzes.index','quizzes.create','quizzes.store','quizzes.show','quizzes.edit',
'quizzes.update','quizzes.destroy','quizzes.generate-text','quizzes.questions.index','quizzes.questions.create',
'quizzes.questions.store','quizzes.questions.edit','quizzes.questions.update','quizzes.questions.destroy','quizzes.questions.update-text',
'results.index','results.quiz','admin.dashboard','admin.reports','admin.settings',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.quizzes.index','admin.quizzes.create','admin.quizzes.store',
'admin.quizzes.show','admin.quizzes.edit','admin.quizzes.update','admin.quizzes.destroy','admin.ai.index',
'admin.ai.generate','admin.ai.generateReport','profile.logout-other-devices','register','generated::jVBImLEemCcKJvMq',
'login','generated::ywnAWJBpwn7Vv5WH','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm',
'generated::KFlvBjsw6aRLU27q','password.update','logout','social.login','social.callback',
'storage.local',);
        registerArgumentsSet('views', 
'about','admin.ai.index','admin.dashboard','admin.quizzes.index','admin.quizzes.show',
'admin.users.create','admin.users.edit','admin.users.index','admin.users.show','auth.confirm-password',
'auth.forgot-password','auth.login','auth.register','auth.reset-password','auth.verify-email',
'completion','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.juzoor-chart','components.modal',
'components.nav-link','components.primary-button','components.quiz-created-modal','components.responsive-nav-link','components.secondary-button',
'components.text-input','dashboard','emails.contact-inquiry','emails.new-device-login','juzoor-model',
'layouts.app','layouts.guest','layouts.navigation','profile.dashboard','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','profile.sessions','question-guide',
'quizzes.create','quizzes.edit','quizzes.index','quizzes.questions.create','quizzes.questions.edit',
'quizzes.questions.index','quizzes.show','quizzes.take','results.show','welcome',
...
'ASSET_URL','APP_TIMEZONE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
'APP_MAINTENANCE_DRIVER','APP_MAINTENANCE_STORE','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL',
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
'DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD','DB_CHARSET',
'DB_COLLATION','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
'SESSION_DOMAIN','SESSION_SECURE_COOKIE','CACHE_STORE','CACHE_PREFIX','CACHE_DRIVER',
'QUEUE_CONNECTION','BROADCAST_CONNECTION','FILESYSTEM_DISK','REDIS_CLIENT','REDIS_HOST',
...
'CLAUDE_API_KEY','CLAUDE_MODEL','CLAUDE_MAX_TOKENS','CLAUDE_TEMPERATURE','CLAUDE_CACHE_ENABLED',
'CLAUDE_TIMEOUT','FEATURE_AI_GENERATION','FEATURE_MANUAL_QUESTIONS','FEATURE_GUEST_ACCESS','FEATURE_REPORTS',
'ADMIN_EMAIL','ADMIN_PASSWORD','VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_HOST',
'VITE_PUSHER_PORT','VITE_PUSHER_SCHEME','VITE_PUSHER_APP_CLUSTER','POSTMARK_TOKEN','RESEND_KEY',
'SLACK_BOT_USER_OAUTH_TOKEN','SLACK_BOT_USER_DEFAULT_CHANNEL','HTTP_PROXY','HTTPS_PROXY','GOOGLE_CLIENT_ID',
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URL','FACEBOOK_APP_ID','FACEBOOK_APP_SECRET','FACEBOOK_REDIRECT_URL',);
